  ...
  apps: [
    {
      ...
      max_restarts: 10,
      restart_delay: 5000,
      log_file: '/wiki/logs/wiki-bot-pm2.log',
      error_file: '/wiki/logs/wiki-bot-error.log',
      out_file: '/wiki/logs/wiki-bot-out.log',
    ...
    },
    {
      ...
      autorestart: false,
      watch: false,
      out_file: '/wiki/logs/cron-daily-out.log',
      error_file: '/wiki/logs/cron-daily-error.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
    },
    {
      ...
      autorestart: false,
      watch: false,
      out_file: '/wiki/logs/cron-promo-out.log',
      error_file: '/wiki/logs/cron-promo-error.log',
      log_date_format: 'YYYY-MM-DD HH:mm:ss',
    },
  ]
};
